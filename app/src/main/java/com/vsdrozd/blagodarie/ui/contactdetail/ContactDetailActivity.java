...
import com.vsdrozd.blagodarie.databinding.ContactDetailActivityBinding;
import com.vsdrozd.blagodarie.databinding.UserLikeFragmentBinding;
import com.vsdrozd.blagodarie.db.scheme.Like;
import com.vsdrozd.blagodarie.server.api.GetAllLikesApi;
import com.vsdrozd.blagodarie.server.api.GetLikesByKeyz;
...
public final class ContactDetailActivity
    ...
    public static class UserLikeFragment
        ...
        private void initViewModel () {
            ...
            //создать фабрику
            final ContactDetailViewModel.Factory factory = new ContactDetailViewModel.Factory(
                    ((BlagodarieApp) requireActivity().getApplication()).getRepository(),
                    userId,
                    contactId
            );
        ...
        public void onCancelLike (@NonNull final Like like) {
            ((BlagodarieApp) requireActivity().getApplication()).
                    getRepository().
                    cancelLike(like).
                    subscribeOn(Schedulers.io()).
                    observeOn(AndroidSchedulers.mainThread()).
    ...
    public static class AllLikeFragment
        ...
        private void getAllLikes () {
            ...
            this.mDisposables.add(
                    Observable.fromCallable(() -> GetLikesByKeyz.getInstance().execute(new GetAllLikesApi.DataIn(((BlagodarieApp) requireActivity().getApplication()).getRepository(), this.mContactDetailViewModel.getContactId())))
                            .subscribeOn(Schedulers.io())
                            .observeOn(AndroidSchedulers.mainThread())

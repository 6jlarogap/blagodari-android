...
import com.vsdrozd.blagodarie.databinding.ContactsFragmentBinding;
...
import static com.vsdrozd.blagodarie.ui.contacts.ContactsActivity.EXTRA_USER_ID;
import static com.vsdrozd.blagodarie.ui.contacts.ContactsActivity.PREF_ORDER_BY;
import static com.vsdrozd.blagodarie.ui.contacts.ContactsOrder.FAME;
import static com.vsdrozd.blagodarie.ui.contacts.ContactsOrder.LIKES_COUNT;
import static com.vsdrozd.blagodarie.ui.contacts.ContactsOrder.NAME;
import static com.vsdrozd.blagodarie.ui.contacts.ContactsOrder.SUM_LIKES_COUNT;
import static com.vsdrozd.blagodarie.ui.contacts.ContactsOrder.UPDATE_TIMESTAMP;
...
public final class ContactsFragment
    ...
    public void onActivityCreated (@Nullable Bundle savedInstanceState) {
        ...
        Diagnostic.i();
        this.mDataRepository = ((BlagodarieApp) requireActivity().getApplication()).getRepository();
        initViewModel();
    ...
    private void setOrder (ContactsOrder contactsOrder) {
        Diagnostic.i();
        mScrollYPosition = 0;
        requireActivity().getSharedPreferences("pref", MODE_PRIVATE).edit().putString(PREF_ORDER_BY, contactsOrder.name()).apply();

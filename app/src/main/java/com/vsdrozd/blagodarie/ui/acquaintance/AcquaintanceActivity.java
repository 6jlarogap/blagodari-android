...
import com.vsdrozd.blagodarie.ui.contacts.ContactsActivity;
import com.vsdrozd.blagodarie.ui.newcontacts.NewContactsActivity;
...
public class AcquaintanceActivity
    ...
    protected void onActivityResult (int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == GoogleSignInListener.ACTIVITY_REQUEST_CODE_GOGGLE_SIGN_IN) {
            if (GoogleSignInListener.getInstance().handleSignInResult(data, userId, ((BlagodarieApp) getApplication()).getRepository())) {
                toContacts();
            }
        }
    }
